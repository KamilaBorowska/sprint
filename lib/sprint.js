...
(function() {
  ...
  sprint = function() {
    ...
    return ("" + string).replace(format, function() {
      var abs, alignCharacter, arg, args, argument, character, defaultPrecision, flags, intSize, leftPad, length, letter, matches, padInteger, precision, prefix, result, special, string, toExponential, type, vector;
