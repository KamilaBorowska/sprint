(function() {
  ...
  sprint = function() {
    ...
    return ("" + string).replace(format, function() {
      var abs, alignCharacter, arg, argument, character, defaultPrecision, flags, intSize, leftPad, length, letter, matches, padInteger, precision, prefix, result, special, string, toExponential, type, vector;
          ...
          argument = (function() {
            ...
            switch (type) {
              ...
              case 'G':
                ...
                if (+arg === 0 || (0.0001 <= (_ref2 = Math.abs(arg)) && _ref2 < Math.pow(10, precision))) {
              ...
              case 's':
                if (defaultPrecision) {
                  ...
                  return argument.substring(0, precision);
                }
                break;
              case 'c':
